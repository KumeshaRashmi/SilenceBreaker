...
RETRIEVAL_GOLD = [
    ("keep a private record of incidents dates times what was said and witnesses to report harassment",
    ...
    ("in immediate physical danger weapons involved threatened to life seek emergency help immediately",
     "kb_emergency_when_to_call.md"),
    ("keep copies of relevant communications documentation evidence private storage",
     "kb_evidence_documentation.md"),
    ("safety planning leaving abusive situation next steps options",
     "kb_domestic_safety_planning.md"),
    ("support organisation helpline domestic abuse refuge shelter services",
     "kb_domestic_support_orgs.md"),
    ("workplace harassment grievance policy reporting to manager HR anti-retaliation",
     "kb_workplace_harassment_reporting.md"),
    ("coping emotionally support self-care trauma recovery",
     "kb_emotional_support_basics.md"),
    ("coercive control pattern dominate frighten strip away freedom independence monitoring finances",
     "kb_coercive_control_signs.md"),
    ("recognising abuse signs controlling behaviour threats intimidation",
